...
set JAVA_HOME=C:\java\JDK\jdk180
set HADOOP_HOME=C:\java\bigData\hadoop-2.6.0
set HADOOP_LOG=C:\java\bigData\logs\hadoop
...
set HADOOP_LOG_DIR=%HADOOP_LOG%

@rem Where log files are stored in the secure data environment.
set HADOOP_SECURE_DN_LOG_DIR=%HADOOP_LOG%
...
set HADOOP_PID_DIR=%HADOOP_HOME%\pid
set HADOOP_SECURE_DN_PID_DIR=%HADOOP_HOME%\pid
